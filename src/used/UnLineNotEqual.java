...
public class UnLineNotEqual {
   ...
   public boolean getFeasibleSolution(double dis,List<SensorNode> list){
	   ...
	   while(rightmost<this.barrier_length){
		  ...
		  for(int i=0;i<list.size();i++){
			  double temp_y=list.get(i).y;
			  if(dis+list.get(i).r>=temp_y){
				  double max_right=Math.sqrt((dis+list.get(i).r)*(dis+list.get(i).r)-temp_y*temp_y);
				  double max_right_y=list.get(i).r*temp_y/(dis+list.get(i).r);
				...
				/*  double t1=list.get(i).x+max_right-Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y);
				  double t2=list.get(i).x+max_right;
				  System.out.println("set1:["+t1+","+t2+"],while r="+rightmost);*/
				  if(list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y)<=rightmost&&list.get(i).x+max_right>=rightmost){
		  ...
		  if(set1.size()!=0){
			  ...
			  rightmost=maxright;
			  double n=maxrightX-Math.sqrt(list.get(max_r).r*list.get(max_r).r-list.get(max_r).y_final*list.get(max_r).y_final);
			  ...
			  for(int i=0;i<list.size();i++){
				  ...
				  if(dis>=list.get(i).y){
					 ...
					 /* double t1=list.get(i).x+right_zero_x_1-this.radius;
					  ...
					  if(list.get(i).x+right_zero_x_1-list.get(i).r<rightmost&&list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y)>rightmost){
						/* double t1=list.get(i).x+right_zero_x_1-list.get(i).r;
						  double t2=list.get(i).x+max_right-Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y);
						  System.out.println("set2_1:["+t1+","+t2+"],while r="+rightmost+":("+list.get(i).x+","+list.get(i).y+")"+" dis"+dis);*/
						  if(!criticalSet.contains(list.get(i))){
						      set2.add(list.get(i));
							  if(minleft>list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y)){
								  minleft=list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y);
				  ...
				  if(dis+list.get(i).r>=list.get(i).y&&dis<list.get(i).y){
						...
						/*  double t1=list.get(i).x-Math.sqrt(this.radius*this.radius-y*y);
						  ...
						  if(list.get(i).x-Math.sqrt(list.get(i).r*list.get(i).r-y*y)<=rightmost&&list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y)>rightmost){
							  double t1=list.get(i).x-Math.sqrt(list.get(i).r*list.get(i).r-y*y);
							  double t2=list.get(i).x+max_right-2*Math.sqrt(list.get(i).r*list.get(i).r-max_right_y*max_right_y);
			 ...
			 if(set2.size()!=0){
				 ...
				 //double temp2=this.radius*this.radius-temp1*temp1-dis*dis+list.get(min_zero_l).y*list.get(min_zero_l).y;
				 double temp2=dis*dis-list.get(min_zero_l).r*list.get(min_zero_l).r-temp1*temp1-list.get(min_zero_l).y*list.get(min_zero_l).y;
				 double temp=temp2*temp2*list.get(min_zero_l).y*list.get(min_zero_l).y-(temp2*temp2-4*temp1*temp1*list.get(min_zero_l).r*list.get(min_zero_l).r)*(list.get(min_zero_l).y*list.get(min_zero_l).y+temp1*temp1);
				 ...
				 if(y1>=0&&Math.abs(list.get(min_zero_l).x+Math.sqrt(dis*dis-(list.get(min_zero_l).y-y1)*(list.get(min_zero_l).y-y1))-Math.sqrt(list.get(min_zero_l).r*list.get(min_zero_l).r-y1*y1)-rightmost)<=0.001){
				   y=y1;
				 }
				 if(y2>=0&&Math.abs(list.get(min_zero_l).x+Math.sqrt(dis*dis-(list.get(min_zero_l).y-y2)*(list.get(min_zero_l).y-y2))-Math.sqrt(list.get(min_zero_l).r*list.get(min_zero_l).r-y2*y2)-rightmost)<=0.001){
				   y=y2; 
				 }
				 if(y!=-1){
					 double x=list.get(min_zero_l).x+Math.sqrt(dis*dis-(list.get(min_zero_l).y-y)*(list.get(min_zero_l).y-y));
					 ...
					 criticalSet.add(list.get(min_zero_l));
					 rightmost=x+Math.sqrt(list.get(min_zero_l).r*list.get(min_zero_l).r-y*y);
					 double n=x-Math.sqrt(list.get(min_zero_l).r*list.get(min_zero_l).r-y*y);
				 ...
				 for(int i=0;i<list.size();i++){
					 if(dis>=list.get(i).y){
						...
						/* double t1=list.get(i).x-zero-this.radius;
						 ...
						 if(list.get(i).x-zero-list.get(i).r<=rightmost&&list.get(i).x+zero-list.get(i).r>=rightmost){
							 if(!criticalSet.contains(list.get(i))){
							      set3.add(list.get(i));
				...
				if(set3.size()!=0){
					 double x=rightmost+list.get(index).r;
					 list.get(index).setXFinal(x);
					 list.get(index).setYFinal(0);
					 criticalSet.add(list.get(index));
					 rightmost=x+list.get(index).r;
					 System.out.println("set3:"+rightmost+" x:"+x+" r:"+list.get(index).r);
				}else{
					 ...
					 for(int i=0;i<list.size();i++){
						 if(dis>=list.get(i).y){
							...
							/* double t1=list.get(i).x-max_right;
							 ...
							 if(list.get(i).x-max_right<=rightmost&&list.get(i).x-zero-list.get(i).r>rightmost){
								 /*double t1=list.get(i).x-max_right;
								 double t2=list.get(i).x-zero;
								 System.out.println("set4_1:["+t1+","+t2+"],while r="+rightmost+":("+list.get(i).x+","+list.get(i).y+")"+" dis"+dis);*/
								 if(!criticalSet.contains(list.get(i))){
								      set4.add(list.get(i));
									  if(min_l>list.get(i).x-zero-list.get(i).r){
										  min_l=list.get(i).x-zero-list.get(i).r;
										  //minleftX=max_right_x;
										  index_l=i;
									  }
								  } 
						 ...
						 if(dis+list.get(i).r>=list.get(i).y&&dis<list.get(i).y){
							 ...
							 if(list.get(i).x-max_right<=rightmost&&list.get(i).x-Math.sqrt(list.get(i).r*list.get(i).r-y*y)>rightmost){
								/* double t1=list.get(i).x-max_right;
								 double t2=list.get(i).x;
								 System.out.println("set4_2:["+t1+","+t2+"],while r="+rightmost+":("+list.get(i).x+","+list.get(i).y+")"+" dis"+dis);*/
								 if(!criticalSet.contains(list.get(i))){
								      set4.add(list.get(i));
									  if(min_l>list.get(i).x-Math.sqrt(list.get(i).r*list.get(i).r-y*y)){
										  min_l=list.get(i).x-Math.sqrt(list.get(i).r*list.get(i).r-y*y);
										  //minleftX=max_right_x;
										  index_l=i;
									  }
								  } 
					...
					if(set4.size()!=0){
						 ...
						 //double temp2=this.radius*this.radius-temp1*temp1-dis*dis+list.get(min_zero_l).y*list.get(min_zero_l).y;
						 double temp2=list.get(index_l).r*list.get(index_l).r+temp1*temp1-dis*dis+list.get(index_l).y*list.get(index_l).y;
						 double temp=temp2*temp2*list.get(index_l).y*list.get(index_l).y-(temp2*temp2-4*temp1*temp1*list.get(index_l).r*list.get(index_l).r)*(list.get(index_l).y*list.get(index_l).y+temp1*temp1);
						 ...
						 if(y1>=0&&Math.abs(list.get(index_l).x-Math.sqrt(dis*dis-(list.get(index_l).y-y1)*(list.get(index_l).y-y1))-Math.sqrt(list.get(index_l).r*list.get(index_l).r-y1*y1)-rightmost)<=0.001){
							   y=y1;
						}
						 if(y2>=0&&Math.abs(list.get(index_l).x-Math.sqrt(dis*dis-(list.get(index_l).y-y2)*(list.get(index_l).y-y2))-Math.sqrt(list.get(index_l).r*list.get(index_l).r-y2*y2)-rightmost)<=0.001){
							   y=y2; 
						}
						 if(y!=-1){
							 ...
							 rightmost=x+Math.sqrt(list.get(index_l).r*list.get(index_l).r-y*y);
							 double n=x+Math.sqrt(list.get(index_l).r*list.get(index_l).r-y*y);
   ...
   private List<Double> getDis1(List<SensorNode> list){
	   ...
	   dis1.add(list.get(list.size()-1).y-list.get(list.size()-1).r);
	   Collections.sort(list,new Comparator<SensorNode>(){
	     public int compare(SensorNode o1,SensorNode o2){
		  return new Double(o2.r).compareTo(new Double(o1.r));   
	   }
	   });
	   double sum=0;
	   int index=0;
	   for(int i=0;i<list.size();i++){
		      if(sum<this.barrier_length){
			   sum+=list.get(i).r;
		       index=i;
		      }else{
		    	  break;
	   ...
	   //others 
	   //int m=(int) Math.ceil(this.barrier_length/(2*minr));
	   //int leastNumber=list.size()/m*m;
	   if(index==list.size()&&sum<this.barrier_length) return null;
	   double distance =1;
	   List<SensorNode> nodeSet = new ArrayList<SensorNode>();
		for(int j=0;j<=index;j++) //1--m is 0--(m-1)

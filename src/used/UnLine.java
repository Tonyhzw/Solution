	   ...
	   while(rightmost<this.barrier_length){
		  ...
		  if(set1.size()!=0){
			  ...
			  for(int i=0;i<list.size();i++){
				  ...
				  if(dis+this.radius>=list.get(i).y&&dis<list.get(i).y){
			 ...
			 if(set2.size()!=0){
				...
				if(set3.size()!=0){
					 ...
					 //System.out.println("set3:"+rightmost+" x:"+x+" r:"+this.radius);
				}else{

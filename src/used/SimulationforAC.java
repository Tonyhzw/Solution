...
public class SimulationforAC {
	...
	*//**
	...
	public static void main(String[] args) throws RowsExceededException, WriteException, IOException {
		...
		WritableWorkbook book=Workbook.createWorkbook(new FileOutputStream("simulation_for_ac_10_90.xls"));
     ...
     //barrier length is the same,while number not for radius is the same
		...
		double square_y=100;
		double value1=-1,value2=-1,value3=-1,value4=-1,ac=0.00001;
	...
	//while(nodeNumber<=140){
		 ...
		 while((times--)>0){
			...
			ac=0.00001;
//			for(int z=0;z<10;z++){
//				UnLine2 algo2 = new UnLine2(barrier_length,radius,nodeList2,ac*Math.pow(10, z));
...
//		    } 
		 ...
		 sheet1.addCell(n2);
		 jxl.write.Number n3 = new  jxl.write.Number(2,index,ac*Math.pow(10, index));
		 sheet1.addCell(n3);
		 jxl.write.Number n4 = new  jxl.write.Number(3,index,sum[index]/time2);
		 sheet1.addCell(n4);
		 }
		book.write();
		book.close();

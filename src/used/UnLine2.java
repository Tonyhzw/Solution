			 ...
			 if(set2.size()!=0){
				 ...
				 //System.out.println("temp2 :"+temp);
				  if(temp<0) temp=-temp;
				   ...
				   y=(Math.sqrt(temp)-list.get(min_zero_l).y*temp2)/(2*(list.get(min_zero_l).y*list.get(min_zero_l).y+temp1*temp1));
				...
				if(set3.size()!=0){
						 ...
						 if(!criticalSet.contains(list.get(i))&&dis+this.radius>=list.get(i).y&&dis<list.get(i).y){
							 ...
							 if(list.get(i).x-max_right<=rightmost&&list.get(i).x-Math.sqrt(this.radius*this.radius-y*y)>rightmost){
								/*double t1=list.get(i).x-max_right;
								 ...
								 //if(!criticalSet.contains(list.get(i))){
								      set4.add(list.get(i));
									  if(min_l>list.get(i).x-Math.sqrt(this.radius*this.radius-y*y)){
										  min_l=list.get(i).x-Math.sqrt(this.radius*this.radius-y*y);
										  //minleftX=max_right_x;
										  index_l=i;
									  }
								 // } 
					...
					if(set4.size()!=0){
						 ...
						 //System.out.println("temp4 :"+temp);
						   y=(list.get(index_l).y*temp2-Math.sqrt(temp))/(2*(list.get(index_l).y*list.get(index_l).y+temp1*temp1));
...
//						}
   ...
   private double binary_search(List<Double> dis,List<SensorNode1> list){
		...
		double lowValue=dis.get(0),highValue=dis.get(1),middleValue=0;

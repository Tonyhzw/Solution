...
public class SimulationSecond {
	...
	*//**
	...
	public static void main(String[] args) throws RowsExceededException, WriteException, IOException {
		...
		WritableWorkbook book=Workbook.createWorkbook(new FileOutputStream("simulation_for_sencond_200_0.0001_3.xls"));
...
//		    double n= algo2.getMinMax();
			...
			for(int z=0;z<3;z++){
				...
				while(node.x==node.x_final&&node.y==node.y_final){
					//chosenNode=r.nextInt(nodeNumber-z);
					if(chosenNode<nodeList1.size()-1)
						   chosenNode++;
					else
						   chosenNode=r.nextInt(nodeNumber-z);	
					node= nodeList1.get(chosenNode);
				}
				nodeList1.remove(chosenNode);
				//System.out.print("list1 moved.");
				...
				//int chosenNode2=r2.nextInt(nodeNumber-z);
				int chosenNode2=chosenNode; 
				SensorNode node2= nodeList2.get(chosenNode2);
				//System.out.print(" "+chosenNode2);
				while(node2.x==node2.x_final&&node2.y==node2.y_final){
					//boolean flag=node2.x==node2.x_final&&node2.y==node2.y_final;
					//System.out.print(".");
					//chosenNode2=r.nextInt(nodeNumber-z);
					if(chosenNode2<nodeList2.size()-1)
					  chosenNode2++;
					else
					  chosenNode2=r.nextInt(nodeNumber-z);	
					//System.out.print(" "+chosenNode2+".");
					node2= nodeList2.get(chosenNode2);
				}
				nodeList2.remove(chosenNode2);	
				//System.out.print("  list2 moved. ");
			}
			//System.out.println("nodes has been moved."+times);
